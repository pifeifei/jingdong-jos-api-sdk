...
class EclpRtwQueryRtwRequest extends AbstractRequest
{
    ...
    {
        return $this->apiParas['startCreateTime'];
    }
    ...
    {
        return $this->apiParas['endCreateTime'];
    }
    ...
    {
        return $this->apiParas['outStoreNo'];
    }
