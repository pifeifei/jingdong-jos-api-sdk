...
class EtmsWaybillSendRequest extends AbstractRequest
{
    ...
    {
        return $this->apiParas['selfPrintWayBill'];
    }
    ...
    {
        return $this->apiParas['packageRequired'];
    }
    ...
    {
        return $this->apiParas['freightPre'];
    }
